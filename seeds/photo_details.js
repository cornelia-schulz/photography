  ...
  return knex('photo_details').del()
    .then(function () {
      ...
      return knex('photo_details').insert([
        ...
        {id: 20, photo_id: 23, language_id: 1, gallery_id: 3, title: 'Harbour Bridge', description: '', location: 'Australia', category: 'cityscape', favourite: 'no'},
        ...
        {id: 26, photo_id: 16, language_id: 1, gallery_id: 3, title: 'Good morning, Sydney', description: '', location: 'Australia', category: 'cityscape', favourite: 'no'},
