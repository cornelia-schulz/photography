  ...
  return knex('photo_details').del()
    .then(function () {
      ...
      return knex('photo_details').insert([
        ...
        {id: 18,photo_id: 15, language_id: 1, gallery_id: 4, title: 'Blue Mountains', description: '', location: 'Australia', category: 'landscape', favourite: 'no'},
        ...
        {id: 24, photo_id: 21, language_id: 1, gallery_id: 4, title: 'Ghostly Tree', description: '', location: 'Australia', category: 'landscape', favourite: 'no'},
        {id: 25, photo_id: 22, language_id: 1, gallery_id: 4, title: 'Desolate', description: '', location: 'Australia', category: 'landscape', favourite: 'no'},
        ...
        {id: 29, photo_id: 26, language_id: 1, gallery_id: 6, title: 'Bridge View', description: '', location: 'Australia', category: 'cityscape', favourite: 'no'},
        {id: 30, photo_id: 27, language_id: 1, gallery_id: 3, title: 'Sails', description: '', location: 'Australia', category: 'cityscape', favourite: 'no'},
        {id: 31, photo_id: 28, language_id: 1, gallery_id: 5, title: 'Rainbow Parikeet', description: '', location: 'Australia', category: 'wildlife', favourite: 'no'}
      ]);
    });
};
